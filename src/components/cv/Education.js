...
function Education() {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1, tranistion: 1 }}
      className="py-10"
    >
      ...
      <div className="mt-14 w-full h-[500px] border-l-[6px] justify-center border-l-black border-opacity-30 flex flex-col gap-10 ">
        <CvCard
        ...
        />
        <CvCard
          title="Secondary School Eduction"
